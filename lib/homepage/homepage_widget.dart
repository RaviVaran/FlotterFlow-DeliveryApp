...
class _HomepageWidgetState extends State<HomepageWidget>
  ...
  void initState() {
    ...
    _model.simplesearchController ??= TextEditingController();
    setupAnimations(
                              ...
                              Expanded(
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      4.0, 0.0, 0.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.simplesearchController,
                                    onChanged: (_) => EasyDebounce.debounce(
                                      '_model.simplesearchController',
                                      Duration(milliseconds: 2000),
                                      () => setState(() {}),
                                    ),
                                    onFieldSubmitted: (_) async {
                                      await queryRestaurantRecordOnce()
                                          .then(
                                            (records) => _model
                                                    .simpleSearchResults =
                                                TextSearch(
                                    ...
                                    validator: _model
                                        .simplesearchControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                      ...
                      child: Builder(
                        builder: (context) {
                          final restaurant = functions
                              .getRestaurantRef(
                                  homepageRestaurantRecordList.toList(),
