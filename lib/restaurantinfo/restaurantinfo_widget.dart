  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<RestaurantRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final restaurantinfoRestaurantRecord = snapshot.data!;
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: FlutterFlowStaticMap(
                            location: restaurantinfoRestaurantRecord.location!,
                            apiKey:
                                'pk.eyJ1IjoicmF2aXZhcmFuIiwiYSI6ImNsa2ljaGV0cTA4eDEzZW1nZnM0aXJma3gifQ.fcYt4467bHLVyynCZq_sPg',
                            style: MapBoxStyle.Light,
                            width: 300.0,
                            height: 300.0,
                            fit: BoxFit.cover,
                            borderRadius: BorderRadius.circular(0.0),
                            markerColor: Color(0xFFFA6262),
                            zoom: 10,
                            tilt: 0,
                            rotation: 0,
                          ),
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            10.0, 10.0, 10.0, 10.0),
                        child: Text(
                          restaurantinfoRestaurantRecord.name,
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            10.0, 10.0, 10.0, 10.0),
                        child: Text(
                          restaurantinfoRestaurantRecord.address,
                          style: FlutterFlowTheme.of(context).bodyMedium,
                        ),
                      ),
                    ],
                  ...
                  Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          'open until ${dateTimeFormat('yMMMd', restaurantinfoRestaurantRecord.close)}',
                          style: FlutterFlowTheme.of(context).bodyMedium,
                        ),
                      ),
                    ],
